;;; Code generated by cl-lsp.LEM-LSP-UTILS/PROTOCOL-GENERATOR based on specification-3-15.md; DO NOT EDIT.
...
* This member MUST NOT exist if there was an error invoking the method."
                        ...
                        (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER
                                        cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN OBJECT
                                        (COMMON-LISP:OR COMMON-LISP:NULL (COMMON-LISP:EQL :NULL)))
...
* information about the error. Can be omitted."
                        :TYPE
                        (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER
                                        cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN ARRAY OBJECT
                                        (COMMON-LISP:OR COMMON-LISP:NULL (COMMON-LISP:EQL :NULL)))
...
*
* @since 3.15.0"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DIAGNOSTIC-TAG) :READER DIAGNOSTIC-TAGS)
                       (RELATED-INFORMATION? :INITARG :RELATED-INFORMATION :DOCUMENTATION "*
* An array of related diagnostic information, e.g. when symbol-names within
* a scope collide all definitions can be marked via this property."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DIAGNOSTIC-RELATED-INFORMATION) :READER
                        DIAGNOSTIC-RELATED-INFORMATION)))
...
(COMMON-LISP:DEFTYPE DIAGNOSTIC-SEVERITY ()
  '(COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER 1)
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER 2)
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER 3)
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER 4)))
...
* invoked with."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMMON-LISP:T) :READER COMMAND-ARGUMENTS)))
...
* The edits to be applied."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY TEXT-EDIT) :READER
                        TEXT-DOCUMENT-EDIT-EDITS)))
...
* Overwrite existing file. Overwrite wins over `ignoreIfExists`"
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER CREATE-FILE-OPTIONS-OVERWRITE)
                       (IGNORE-IF-EXISTS? :INITARG :IGNORE-IF-EXISTS :DOCUMENTATION "*
* Ignore if exists."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER
                        CREATE-FILE-OPTIONS-IGNORE-IF-EXISTS)))

(COMMON-LISP:DEFCLASS CREATE-FILE (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A create"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "create") :READER
                        CREATE-FILE-KIND)
...
* Overwrite target if existing. Overwrite wins over `ignoreIfExists`"
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER RENAME-FILE-OPTIONS-OVERWRITE)
                       (IGNORE-IF-EXISTS? :INITARG :IGNORE-IF-EXISTS :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS RENAME-FILE (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A rename"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "rename") :READER
                        RENAME-FILE-KIND)
...
* Delete the content recursively if a folder is denoted."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER DELETE-FILE-OPTIONS-RECURSIVE)
...
(COMMON-LISP:DEFCLASS DELETE-FILE (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A delete"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "delete") :READER
                        DELETE-FILE-KIND)
                       (URI :INITARG :URI :DOCUMENTATION "*
* The file to delete."
...
* Holds changes to existing resources."
                        ...
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("uri" :TYPE
                          (cl-lsp.LEM-LSP-UTILS/TYPE:TS-OBJECT DOCUMENT-URI
                           (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY TEXT-EDIT))
...
* only plain `TextEdit`s using the `changes` property are supported."
                        :TYPE
                        (COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY TEXT-DOCUMENT-EDIT)
                                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY
...
*
* @since 3.13.0"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY RESOURCE-OPERATION-KIND) :READER
                        WORKSPACE-EDIT-CLIENT-CAPABILITIES-RESOURCE-OPERATIONS)
...
(COMMON-LISP:DEFTYPE RESOURCE-OPERATION-KIND ()
  '(COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "create")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "rename")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "delete")))
...
(COMMON-LISP:DEFTYPE FAILURE-HANDLING-KIND ()
  '(COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "abort")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "transactional")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "undo")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "textOnlyTransactional")))
...
(COMMON-LISP:DEFTYPE DOCUMENT-SELECTOR () '(cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DOCUMENT-FILTER))
...
(COMMON-LISP:DEFTYPE MARKUP-KIND ()
  '(COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "plaintext")
                   (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "markdown")))
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-BEGIN (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "begin") :READER
                        WORK-DONE-PROGRESS-BEGIN-KIND)
                       (TITLE :INITARG :TITLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-REPORT (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "report") :READER
                        WORK-DONE-PROGRESS-REPORT-KIND)
                       (CANCELLABLE? :INITARG :CANCELLABLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-END (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "end") :READER
                        WORK-DONE-PROGRESS-END-KIND)
                       (MESSAGE? :INITARG :MESSAGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-OPTIONS (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((WORK-DONE-PROGRESS? :INITARG :WORK-DONE-PROGRESS :DOCUMENTATION "" :TYPE
                        cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER
                        WORK-DONE-PROGRESS-OPTIONS-WORK-DONE-PROGRESS)))
...
* The initial trace setting. If omitted trace is disabled ('off')."
                        :TYPE
                        (COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "off")
                                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "messages")
                                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER "verbose"))
...
* @since 3.6.0"
                        :TYPE
                        (COMMON-LISP:OR (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY WORKSPACE-FOLDER)
                                        (COMMON-LISP:OR COMMON-LISP:NULL (COMMON-LISP:EQL :NULL)))
...
* Workspace specific client capabilities."
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("applyEdit" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P COMMON-LISP:T)
                         ...
                         ("executeCommand" :TYPE EXECUTE-COMMAND-CLIENT-CAPABILITIES :OPTIONAL-P
                          COMMON-LISP:T)
                         ("workspaceFolders" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T)
                         ("configuration" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T))
...
* Window specific client capabilities."
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("workDoneProgress" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T))
...
* (3) if user selected retry the initialize method is sent again."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER INITIALIZE-ERROR-RETRY)))
...
* The server provides hover support."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN HOVER-OPTIONS) :READER
                        SERVER-CAPABILITIES-HOVER-PROVIDER)
...
* @since 3.14.0"
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN DECLARATION-OPTIONS
                                        DECLARATION-REGISTRATION-OPTIONS)
                        :READER SERVER-CAPABILITIES-DECLARATION-PROVIDER)
                       (DEFINITION-PROVIDER? :INITARG :DEFINITION-PROVIDER :DOCUMENTATION "*
* The server provides goto definition support."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN DEFINITION-OPTIONS)
...
* @since 3.6.0"
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN TYPE-DEFINITION-OPTIONS
                                        TYPE-DEFINITION-REGISTRATION-OPTIONS)
...
* The server provides document symbol support."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN DOCUMENT-SYMBOL-OPTIONS)
...
* `textDocument.codeAction.codeActionLiteralSupport`."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN CODE-ACTION-OPTIONS)
...
* @since 3.6.0"
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN DOCUMENT-COLOR-OPTIONS
                                        DOCUMENT-COLOR-REGISTRATION-OPTIONS)
...
* The server provides document formatting."
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN DOCUMENT-FORMATTING-OPTIONS)
...
* The server provides document range formatting."
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN
                                        DOCUMENT-RANGE-FORMATTING-OPTIONS)
...
* `prepareSupport` in its initial `initialize` request."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN RENAME-OPTIONS) :READER
                        SERVER-CAPABILITIES-RENAME-PROVIDER)
...
* @since 3.10.0"
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN FOLDING-RANGE-OPTIONS
                                        FOLDING-RANGE-REGISTRATION-OPTIONS)
...
* @since 3.15.0"
                        :TYPE
                        (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN SELECTION-RANGE-OPTIONS
                                        SELECTION-RANGE-REGISTRATION-OPTIONS)
...
* The message action items to present."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY MESSAGE-ACTION-ITEM) :READER
                        SHOW-MESSAGE-REQUEST-PARAMS-ACTIONS)))
...
(COMMON-LISP:DEFCLASS REGISTRATION-PARAMS (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((REGISTRATIONS :INITARG :REGISTRATIONS :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY REGISTRATION) :READER
                        REGISTRATION-PARAMS-REGISTRATIONS)))
...
(COMMON-LISP:DEFCLASS UNREGISTRATION-PARAMS (cl-lsp.LEM-LSP-utils/json:OBJECT)
 ...
 of the specification."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY UNREGISTRATION) :READER
                        UNREGISTRATION-PARAMS-UNREGISTERATIONS)))
...
* using the `client/unregisterCapability` request."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN)
...
* The array of added workspace folders"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY WORKSPACE-FOLDER) :READER
                        WORKSPACE-FOLDERS-CHANGE-EVENT-ADDED)
...
(COMMON-LISP:DEFCLASS CONFIGURATION-PARAMS (cl-lsp.LEM-LSP-utils/json:OBJECT)
                      ((ITEMS :INITARG :ITEMS :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY CONFIGURATION-ITEM) :READER
                        CONFIGURATION-PARAMS-ITEMS)))
...
* The watchers to register."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY FILE-SYSTEM-WATCHER) :READER
                        DID-CHANGE-WATCHED-FILES-REGISTRATION-OPTIONS-WATCHERS)))
...
* The actual file events."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY FILE-EVENT) :READER
                        DID-CHANGE-WATCHED-FILES-PARAMS-CHANGES)))
...
* Specific capabilities for the `SymbolKind` in the `workspace/symbol` request."
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY SYMBOL-KIND) :OPTIONAL-P
                          COMMON-LISP:T))
...
* The commands to be executed on the server"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER
                        EXECUTE-COMMAND-OPTIONS-COMMANDS)))
...
* Arguments that the command should be invoked with."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMMON-LISP:T) :READER
                        EXECUTE-COMMAND-PARAMS-ARGUMENTS)))
...
*   you receive them."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY TEXT-DOCUMENT-CONTENT-CHANGE-EVENT)
                        :READER DID-CHANGE-TEXT-DOCUMENT-PARAMS-CONTENT-CHANGES)))

(COMMON-LISP:DEFTYPE TEXT-DOCUMENT-CONTENT-CHANGE-EVENT ()
  '(COMMON-LISP:OR
    (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE ("range" :TYPE RANGE :OPTIONAL-P COMMON-LISP:NIL)
     ("rangeLength" :TYPE COMMON-LISP:NUMBER :OPTIONAL-P COMMON-LISP:T)
     ("text" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL))
    (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE ("text" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL))))
...
* The client is supposed to include the content on save."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER SAVE-OPTIONS-INCLUDE-TEXT)))
...
* sent."
                        :TYPE (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN SAVE-OPTIONS) :READER
                        TEXT-DOCUMENT-SYNC-OPTIONS-SAVE)))
...
* @since 3.15.0"
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DIAGNOSTIC-TAG) :OPTIONAL-P
                          COMMON-LISP:NIL))
...
* An array of diagnostic information items."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DIAGNOSTIC) :READER
                        PUBLISH-DIAGNOSTICS-PARAMS-DIAGNOSTICS)))
...
* capabilities."
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("snippetSupport" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T)
                         ("commitCharactersSupport" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T)
                         ("documentationFormat" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY MARKUP-KIND)
                          :OPTIONAL-P COMMON-LISP:T)
                         ("deprecatedSupport" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T)
                         ("preselectSupport" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                          COMMON-LISP:T)
                         ("tagSupport" :TYPE
                          (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                           ("valueSet" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMPLETION-ITEM-TAG)
                       ...
                       (COMPLETION-ITEM-KIND? :INITARG :COMPLETION-ITEM-KIND :DOCUMENTATION "" :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMPLETION-ITEM-KIND)
                          :OPTIONAL-P COMMON-LISP:T))
...
* this list."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER COMPLETION-LIST-IS-INCOMPLETE)
                       (ITEMS :INITARG :ITEMS :DOCUMENTATION "*
* The completion items."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMPLETION-ITEM) :READER
                        COMPLETION-LIST-ITEMS)))
...
(COMMON-LISP:DEFTYPE COMPLETION-ITEM-TAG () '(cl-lsp.LEM-LSP-UTILS/TYPE:TS-EQUAL-SPECIALIZER 1))
...
*
* @since 3.15.0"
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY COMPLETION-ITEM-TAG) :READER
                        COMPLETION-ITEM-TAGS)
...
* @deprecated Use `tags` instead if supported."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER COMPLETION-ITEM-DEPRECATED)
...
* item of those that match best is selected."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER COMPLETION-ITEM-PRESELECT)
...
* property. The order describes the preferred format of the client."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY MARKUP-KIND) :READER
                        HOVER-CLIENT-CAPABILITIES-CONTENT-FORMAT)))
...
* The hover's content"
                        :TYPE
                        (COMMON-LISP:OR MARKED-STRING (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY MARKED-STRING)
                                        MARKUP-CONTENT)
...
* specific properties."
                        ...
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ...
                         ("parameterInformation" :TYPE
                          (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                           ("labelOffsetSupport" :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :OPTIONAL-P
                            COMMON-LISP:T))
                          :OPTIONAL-P COMMON-LISP:T))
...
* request should return `null`."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY SIGNATURE-INFORMATION) :READER
                        SIGNATURE-HELP-SIGNATURES)
...
* The parameters of this signature."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY PARAMETER-INFORMATION) :READER
                        SIGNATURE-INFORMATION-PARAMETERS)))
...
* Its intended use case is to highlight the parameter label part in the `SignatureInformation.label`."
                        :TYPE
                        (COMMON-LISP:OR COMMON-LISP:STRING
                                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-TUPLE COMMON-LISP:NUMBER
                                         COMMON-LISP:NUMBER))
...
* Indicates if this symbol is deprecated."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER DOCUMENT-SYMBOL-DEPRECATED)
                       (RANGE :INITARG :RANGE :DOCUMENTATION "*
...
* Children of this symbol, e.g. properties of a class."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY DOCUMENT-SYMBOL) :READER
                        DOCUMENT-SYMBOL-CHILDREN)))
...
* The kind of this symbol."
                       ...
                       (DEPRECATED? :INITARG :DEPRECATED :DOCUMENTATION "*
* Indicates if this symbol is deprecated."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER SYMBOL-INFORMATION-DEPRECATED)
                       (LOCATION :INITARG :LOCATION :DOCUMENTATION "*
...
* @since 3.8.0"
                        ...
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                         ("codeActionKind" :TYPE
                          (cl-lsp.LEM-LSP-UTILS/TYPE:TS-INTERFACE
                           ("valueSet" :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY CODE-ACTION-KIND)
                            :OPTIONAL-P COMMON-LISP:NIL))
                          :OPTIONAL-P COMMON-LISP:NIL))
...
* may list out every specific kind they provide."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY CODE-ACTION-KIND) :READER
                        CODE-ACTION-OPTIONS-CODE-ACTION-KINDS)))
...
*
* @since 3.15.0"
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER CODE-ACTION-IS-PREFERRED)
                       (EDIT? :INITARG :EDIT :DOCUMENTATION "*
...
* Prefer spaces over tabs."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER FORMATTING-OPTIONS-INSERT-SPACES)
...
* Signature for further properties."
                        :TYPE
                        (cl-lsp.LEM-LSP-UTILS/TYPE:TS-OBJECT COMMON-LISP:STRING
                         (COMMON-LISP:OR cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN COMMON-LISP:NUMBER
                                         COMMON-LISP:STRING))
...
* Renames should be checked and tested before being executed."
                        :TYPE cl-lsp.LEM-LSP-UTILS/TYPE:TS-BOOLEAN :READER RENAME-OPTIONS-PREPARE-PROVIDER)))
...
* The positions inside the text document."
                        :TYPE (cl-lsp.LEM-LSP-UTILS/TYPE:TS-ARRAY POSITION) :READER
                        SELECTION-RANGE-PARAMS-POSITIONS)))
